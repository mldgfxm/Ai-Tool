...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (AIsnake)
...
After starting the proxy and enabling app takeover, AIsnake modifies app configurations:
...
When stopping the proxy, AIsnake will:
