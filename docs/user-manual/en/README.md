...
| File | Description |
|------|-------------|
| [5.1-config-files.md](./5-faq/5.1-config-files.md) | AIsnake storage, CLI configuration file formats |
...
- [GitHub Issues](https://github.com/farion1231/aisnake/issues)
- [GitHub Repository](https://github.com/farion1231/aisnake)
