...
AIsnake provides rich icon customization features:
...
This ensures AIsnake and CLI tool configurations stay in sync.
...
When adding a provider, AIsnake automatically extracts endpoint URLs from the configuration.
