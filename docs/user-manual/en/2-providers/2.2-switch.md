...
2. AIsnake updates the configuration file
...
1. Right-click the AIsnake icon in the system tray
...
When switching providers, AIsnake modifies the following files:
