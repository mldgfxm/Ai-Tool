...
- **ArchLinux Installation Support** (#259)
  Added AUR installation method: `paru -S aisnake-bin`
...
Visit [Releases](https://github.com/farion1231/aisnake/releases/latest) to download the latest version
...
- **Deep link integration** - Import via `aisnake://` protocol
...
v3.7.0 represents a shift in AIsnake's positioning:
...
[Register with "aisnake" code for 10% discount](https://www.packyapi.com/register?aff=aisnake)
...
- **Issues**: [GitHub Issues](https://github.com/farion1231/aisnake/issues)
- **Discussions**: [GitHub Discussions](https://github.com/farion1231/aisnake/discussions)
