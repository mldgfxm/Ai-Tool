...
//!
//! Parses aisnake:// URLs into DeepLinkImportRequest structures.
...
/// Parse a aisnake:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// aisnake://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "aisnake" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'aisnake', got '{scheme}'"
        )));
    }
