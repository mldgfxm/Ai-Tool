//! Deep link import functionality for AIsnake
//!
//! This module implements the aisnake:// protocol for importing configurations
...
///
/// Represents a parsed aisnake:// URL ready for processing.
